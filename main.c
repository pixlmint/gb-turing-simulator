...
char* getAdditionConfiguration() {
    return "";
}
...
uint8_t displayMenu(TuringMachine *tm) {
    ...
    if (selectedMachine == 0) {
        ...
        machineConfiguration = getAdditionConfiguration();
    } else {
