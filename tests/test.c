...
void test_machineExecution(void) {
    ...
    const char *config2 = "010010100100110101000101001100010010100100110001010010100111010";
    parseConfiguration(&tm, config2);
    runMachineTest(&tm);
    CU_ASSERT_NOT_EQUAL(tm.currentState, 1);

    const char *config3 = "0100101001001101010001010011000100101001001100010100101001110100";
    parseConfiguration(&tm, config3);
    runMachineTest(&tm);
    CU_ASSERT_EQUAL(tm.currentState, 1);
}
